...
<body>
    <div class="wrapper">
        ...
        @include('base-templates.partial.header')

        @include('base-templates.partial.navbar')
        ...
        <div class="page-wrapper">
            ...
            @include('base-templates.partial.footer')
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            // $('#table').DataTable(); // call datatable
        });
    </script>
    <script>
        // @formatter:off
    ...
    <script>
        var check = document.getElementById('is_active')
        console.log(check)
